      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-surface border border-borders rounded-3xl p-8 shadow-2xl flex flex-col gap-8">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div>
              <h2 className="font-general-sans text-2xl font-black uppercase text-primary tracking-wide">Welcome Back</h2>
              <p className="font-sans text-xs text-neutral-gray mt-1">Access your bookings, favorites & checkout settings.</p>
            </div>
          </div>
          ...
          <div className="text-center font-sans text-xs text-neutral-gray border-t border-borders pt-6">
            New to Ziko EV?{" "}
            <Link href="/auth/register" className="text-[#BFFF07] font-semibold hover:underline">
              Create an account
            </Link>
          </div>
        </div>
